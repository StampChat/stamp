<template>
  <div>
    ...
    <q-scroll-area
      ref="chatScroll"
      class="q-px-md row"
      :style="`height: calc(100% - ${offsetHeight()}px); min-height: calc(100%-${offsetHeight()}px); background: ${bodyBackground}`"
    >
      <q-chat-message
        class="q-py-sm"
...
export default {
  ...
  data () {
    return {
      ...
      message: '',
      replyDigest: null,
      bodyBackground: this.$q.dark.isActive ? '#121212' : 'lightblue',
      donationMessage
    }
  },
  created () {
