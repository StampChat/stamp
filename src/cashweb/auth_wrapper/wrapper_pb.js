...
goog.exportSymbol('proto.wrapper.AuthWrapperSet', null, global);
...
proto.wrapper.AuthWrapper = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.wrapper.AuthWrapper.repeatedFields_, null);
};
 ...
 * @constructor
 */
proto.wrapper.AuthWrapperSet = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.wrapper.AuthWrapperSet.repeatedFields_, null);
};
goog.inherits(proto.wrapper.AuthWrapperSet, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.wrapper.AuthWrapperSet.displayName = 'proto.wrapper.AuthWrapperSet';
}
 ...
 * @const
 */
proto.wrapper.AuthWrapper.repeatedFields_ = [7];
 ...
 * @return {number}
 */
proto.wrapper.AuthWrapper.prototype.getBurnAmount = function() {
 ...
 * @return {!proto.wrapper.AuthWrapper} returns this
 */
proto.wrapper.AuthWrapper.prototype.setBurnAmount = function(value) {
 ...
 */
proto.wrapper.AuthWrapper.prototype.getTransactionsList = function() {
 ...
 * @return {!proto.wrapper.AuthWrapper} returns this
*/
proto.wrapper.AuthWrapper.prototype.setTransactionsList = function(value) {
 ...
 * @return {!proto.wrapper.BurnOutputs}
 */
proto.wrapper.AuthWrapper.prototype.addTransactions = function(opt_value, opt_index) {
 ...
 * @return {!proto.wrapper.AuthWrapper} returns this
 */
proto.wrapper.AuthWrapper.prototype.clearTransactionsList = function() {
 ...
 * @const
 */
proto.wrapper.AuthWrapperSet.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.wrapper.AuthWrapperSet.prototype.toObject = function(opt_includeInstance) {
  return proto.wrapper.AuthWrapperSet.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.wrapper.AuthWrapperSet} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.wrapper.AuthWrapperSet.toObject = function(includeInstance, msg) {
  var f, obj = {
    itemsList: jspb.Message.toObjectList(msg.getItemsList(),
    proto.wrapper.AuthWrapper.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.wrapper.AuthWrapperSet}
 */
proto.wrapper.AuthWrapperSet.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.wrapper.AuthWrapperSet;
  return proto.wrapper.AuthWrapperSet.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.wrapper.AuthWrapperSet} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.wrapper.AuthWrapperSet}
 */
proto.wrapper.AuthWrapperSet.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.wrapper.AuthWrapper;
      reader.readMessage(value,proto.wrapper.AuthWrapper.deserializeBinaryFromReader);
      msg.addItems(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.wrapper.AuthWrapperSet.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.wrapper.AuthWrapperSet.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.wrapper.AuthWrapperSet} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.wrapper.AuthWrapperSet.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.wrapper.AuthWrapper.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Array<!proto.wrapper.AuthWrapper>}
 */
proto.wrapper.AuthWrapperSet.prototype.getItemsList = function() {
  return /** @type{!Array<!proto.wrapper.AuthWrapper>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.wrapper.AuthWrapper, 1));
};


/**
 * @param {!Array<!proto.wrapper.AuthWrapper>} value
 * @return {!proto.wrapper.AuthWrapperSet} returns this
*/
proto.wrapper.AuthWrapperSet.prototype.setItemsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.wrapper.AuthWrapper=} opt_value
 * @param {number=} opt_index
 * @return {!proto.wrapper.AuthWrapper}
 */
proto.wrapper.AuthWrapperSet.prototype.addItems = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.wrapper.AuthWrapper, opt_index);
};
 ...
 * @return {!proto.wrapper.AuthWrapperSet} returns this
 */
proto.wrapper.AuthWrapperSet.prototype.clearItemsList = function() {
