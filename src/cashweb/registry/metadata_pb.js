...
goog.exportSymbol('proto.keyserver.AddressEntry', null, global);
 ...
 * @constructor
 */
proto.keyserver.AddressEntry = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.keyserver.AddressEntry, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.keyserver.AddressEntry.displayName = 'proto.keyserver.AddressEntry';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.keyserver.AddressEntry.prototype.toObject = function(opt_includeInstance) {
  return proto.keyserver.AddressEntry.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.keyserver.AddressEntry} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.keyserver.AddressEntry.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.keyserver.AddressEntry}
 */
proto.keyserver.AddressEntry.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.keyserver.AddressEntry;
  return proto.keyserver.AddressEntry.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.keyserver.AddressEntry} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.keyserver.AddressEntry}
 */
proto.keyserver.AddressEntry.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.keyserver.AddressEntry.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.keyserver.AddressEntry.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.keyserver.AddressEntry} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.keyserver.AddressEntry.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getKind();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.keyserver.AddressEntry.prototype.getKind = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.keyserver.AddressEntry} returns this
 */
proto.keyserver.AddressEntry.prototype.setKind = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 */
proto.keyserver.AddressEntry.prototype.getHeadersMap = function(opt_noLazyCreate) {
 ...
 * @return {!proto.keyserver.AddressEntry} returns this
 */
proto.keyserver.AddressEntry.prototype.clearHeadersMap = function() {
 ...
 */
proto.keyserver.AddressEntry.prototype.getBody = function() {
 ...
 * @return {string}
 */
proto.keyserver.AddressEntry.prototype.getBody_asB64 = function() {
 ...
 * @return {!Uint8Array}
 */
proto.keyserver.AddressEntry.prototype.getBody_asU8 = function() {
 ...
 * @return {!proto.keyserver.AddressEntry} returns this
 */
proto.keyserver.AddressEntry.prototype.setBody = function(value) {
 ...
 * @const
 */
proto.keyserver.AddressMetadata.repeatedFields_ = [4];
...
proto.keyserver.AddressMetadata.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.keyserver.AddressEntry.toObject, includeInstance)
  };
...
proto.keyserver.AddressMetadata.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 4:
      var value = new proto.keyserver.AddressEntry;
      reader.readMessage(value,proto.keyserver.AddressEntry.deserializeBinaryFromReader);
...
proto.keyserver.AddressMetadata.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      4,
      f,
      proto.keyserver.AddressEntry.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!(string|Uint8Array)}
 */
proto.keyserver.AddressMetadata.prototype.getPubkey = function() {
 ...
 * @return {string}
 */
proto.keyserver.AddressMetadata.prototype.getPubkey_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getPubkey()));
};
 ...
 * @return {!Uint8Array}
 */
proto.keyserver.AddressMetadata.prototype.getPubkey_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getPubkey()));
};
 ...
 */
proto.keyserver.AddressMetadata.prototype.setPubkey = function(value) {
 ...
 * @return {!Array<!proto.keyserver.AddressEntry>}
 */
proto.keyserver.AddressMetadata.prototype.getEntriesList = function() {
  return /** @type{!Array<!proto.keyserver.AddressEntry>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.keyserver.AddressEntry, 4));
};


/**
 * @param {!Array<!proto.keyserver.AddressEntry>} value
 * @return {!proto.keyserver.AddressMetadata} returns this
*/
...
/**
 * @param {!proto.keyserver.AddressEntry=} opt_value
 * @param {number=} opt_index
 * @return {!proto.keyserver.AddressEntry}
 */
proto.keyserver.AddressMetadata.prototype.addEntries = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 4, opt_value, proto.keyserver.AddressEntry, opt_index);
};
